...
\DoxyCodeLine{Last run elapsed t  : 65.00ms}
\DoxyCodeLine{Last run speed      : 15.32 million agents x day / second}
...
\DoxyCodeLine{  -\/ (2) Recovered   :     0 -\/> 9417}
\DoxyCodeLine{  -\/ (3) Removed     :     0 -\/> 583}
\DoxyCodeLine{}
\DoxyCodeLine{Transition Probabilities:}
\DoxyCodeLine{ -\/ Susceptible  0.79  0.21     -\/     -\/}
