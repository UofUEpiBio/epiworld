...
/**
 * @brief Test heterogeneous contact rates in ModelSIRMixing
 *
 ...
 */
EPIWORLD_TEST_CASE(
    "SIRMixing heterogeneous contact rates",
    "[SIR-mixing-hetero]"
) {
    ...
    epimodels::ModelSIRMixing<> model(
        ...
        0.1,               // transmission_rate (low to keep outbreaks small)
    ...
    // Print results
    std::cout << "========================================================" << std::endl;
    std::cout << "Heterogeneous contact rates test (ModelSIRMixing)" << std::endl;
