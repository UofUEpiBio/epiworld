    ...
    )
{
    ...
    EPI_NEW_VIRUSFUN_LAMBDA(add_immunity,TSeq) {
        ...
        immune.set_susceptibility_reduction(virus_immune);
    ...
    EPI_NEW_TOOL_LAMBDA(immune_susceptibility_reduction,TSeq) {return MPAR(0);};
    ...
    immune_sys.set_susceptibility_reduction(immune_susceptibility_reduction);
    immune_sys.set_recovery(immune_recovery);

    immune_sys.add_param(susceptibility_reduction, "Immune susceptibility_reduction", model);
