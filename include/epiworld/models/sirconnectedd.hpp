#ifndef EPIWORLD_MODELS_SIRCONNECTEDD_HPP 
#define EPIWORLD_MODELS_SIRCONNECTEDD_HPP

template<typename TSeq = EPI_DEFAULT_TSEQ>
class ModelSIRCONND : public epiworld::Model<TSeq>
{
private:
...
inline void ModelSIRCONND<TSeq>::run(
    epiworld_fast_uint ndays,
    int seed
)
{
...
template<typename TSeq>
inline void ModelSIRCONND<TSeq>::reset()
{
...
template<typename TSeq>
inline Model<TSeq> * ModelSIRCONND<TSeq>::clone_ptr()
{
    
    ModelSIRCONND<TSeq> * ptr = new ModelSIRCONND<TSeq>(
        *dynamic_cast<const ModelSIRCONND<TSeq>*>(this)
        );
 ...
 */
template<typename TSeq>
inline ModelSIRCONND<TSeq>::ModelSIRCONND(
    ModelSIRCONND<TSeq> & model,
    std::string vname,
    epiworld_fast_uint n,
    epiworld_double prevalence,
    ...
    )
{
    ...
    epiworld::UpdateFun<TSeq> update_susceptible = [](
        ...
        ) -> void
        {
            ...
            for (int i = 0; i < ndraw; ++i)
            {
                ...
                if (neighbor.get_state() == ModelSIRCONND<TSeq>::INFECTED)
                {
    ...
    epiworld::UpdateFun<TSeq> update_infected = [](
        epiworld::Agent<TSeq> * p, epiworld::Model<TSeq> * m
            ...
            if (state == ModelSIRCONND<TSeq>::INFECTED)
            {
